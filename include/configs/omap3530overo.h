...
#define CONFIG_3530OVERO        1    /* working on OMAP3530 OVERO */
...
#define V_NS16550_CLK            (48000000)  /* 1.8432 Mhz */
...
#define CONFIG_COMMANDS		((CFG_CMD_I2C | CONFIG_CMD_DFL |\
                              ...
                              CFG_CMD_NAND) & ~(C_MSK | CFG_CMD_NET | CFG_CMD_NFS | \
                                                CFG_CMD_FPGA | CFG_CMD_IMI))
