/*
 * U-Boot configuration for Santiago
 *
...
/* Even thought it looks like a simple define for mapping NS16550 to OMAP HW, */
/* it actually is a little bit more. Every port defined here will be          */
/* initialized. Since that will not always be possible, only define the port  */
/* which will be used for the console.                                        */
#ifdef SIMSANTIAGO
...
#define CFG_NS16550_COM4         OMAP34XX_UART4
